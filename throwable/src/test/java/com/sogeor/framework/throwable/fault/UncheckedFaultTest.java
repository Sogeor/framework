...
final class UncheckedFaultTest {

    @Test
    void defaultMessageField() {
        assertNull(UncheckedFault.DEFAULT_MESSAGE);
    }

    @Test
    void defaultCauseField() {
        assertNull(UncheckedFault.DEFAULT_CAUSE);
    }

    @Test
    void defaultSuppressionField() {
        assertTrue(UncheckedFault.DEFAULT_SUPPRESSION);
    }

    @Test
    void defaultStackTraceField() {
        assertTrue(UncheckedFault.DEFAULT_STACK_TRACE);
    }

    @Test
    void defaultConstructor() {
        final @NonNull var instance = new UncheckedFault();
        final @NonNull var exception = new Exception();
        instance.addSuppressed(exception);
        assertEquals(UncheckedFault.DEFAULT_MESSAGE, instance.getMessage());
        assertEquals(UncheckedFault.DEFAULT_CAUSE, instance.getCause());
    ...
    void constructorWithMessage() {
        ...
        final @NonNull var instance = new UncheckedFault(message);
        final @NonNull var exception = new Exception();
        instance.addSuppressed(exception);
    ...
    void constructorWithCause() {
        ...
        final @NonNull var instance = new UncheckedFault(cause);
        final @NonNull var exception = new Exception();
        instance.addSuppressed(exception);
        assertEquals(UncheckedFault.DEFAULT_MESSAGE, instance.getMessage());
    ...
    void constructorWithMessageAndCause() {
        final @NonNull var message = "The test message";
        final @NonNull var cause = new Exception();
        final @NonNull var instance = new UncheckedFault(message, cause);
        final @NonNull var exception = new Exception();
        instance.addSuppressed(exception);
        assertEquals(message, instance.getMessage());
        assertEquals(cause, instance.getCause());
    ...
    void constructorWithSuppressionAndStackTrace() {
        final @NonNull var instance = new UncheckedFault(false, false);
        final @NonNull var exception = new Exception();
        instance.addSuppressed(exception);
        assertEquals(UncheckedFault.DEFAULT_MESSAGE, instance.getMessage());
        assertEquals(UncheckedFault.DEFAULT_CAUSE, instance.getCause());
    ...
    void constructorWithMessageAndCauseAndSuppressionAndStackTrace() {
        final @NonNull var message = "The test message";
        final @NonNull var cause = new Exception();
        final @NonNull var instance = new UncheckedFault(message, cause, false, false);
        final @NonNull var exception = new Exception();
        instance.addSuppressed(exception);
        assertEquals(message, instance.getMessage());
        assertEquals(cause, instance.getCause());
