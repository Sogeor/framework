...
/**
 * Представляет собой проверяемый программный сбой, то есть сбой, который должен быть перехвачен и обработан или передан
 * дальше.
 *
 * @apiNote При его обработке следует завершать работу программы, так как он подразумевает наличие критических
