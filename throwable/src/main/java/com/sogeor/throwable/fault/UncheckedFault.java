...
/**
 * Представляет собой непроверяемую неисправность программы, то есть неисправность, которая может быть перехвачена и
 * обработана или передана дальше.
 *
 * @apiNote При её обработке чаще всего следует продолжать работу программы.
 * @see CheckedFault
 * @since 1.0.0-RC1
 */
