...
/**
 * Представляет собой непроверяемую неисправность программы, возникающую из-за ошибки валидации нулевого аргумента, то
 * есть аргумента, который не должен быть нулевым, но таковым является.
 *
 * @since 1.0.0-RC1
 */
public class NullArgumentValidationFault extends ArgumentValidationFault {
     ...
     * @since 1.0.0-RC1
     */
    public static final @NotNull String DEFAULT_MESSAGE = "The passed argument mustn't be null";
     ...
     * @since 1.0.0-RC1
     */
    public static final @NotNull String TEMPLATE_MESSAGE = "%s mustn't be null";
     ...
     */
    @Contract(pure = true)
    public NullArgumentValidationFault() {
     ...
     */
    @Contract(pure = true)
    public NullArgumentValidationFault(final @Nullable String message) {
     ...
     */
    @Contract(pure = true)
    public NullArgumentValidationFault(final @Nullable Throwable cause) {
     ...
     */
    @Contract(pure = true)
    public NullArgumentValidationFault(final @Nullable String message, final @Nullable Throwable cause) {
     ...
     */
    @Contract(pure = true)
    public NullArgumentValidationFault(final boolean suppression, final boolean stackTrace) {
