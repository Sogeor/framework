 ...
 * @since 1.0.0-RC1
 */
public class ArgumentValidationFault extends ValidationFault {
     ...
     */
    @Contract(pure = true)
    public ArgumentValidationFault(final @Nullable String message) {
     ...
     */
    @Contract(pure = true)
    public ArgumentValidationFault(final @Nullable Throwable cause) {
     ...
     */
    @Contract(pure = true)
    public ArgumentValidationFault(final @Nullable String message, final @Nullable Throwable cause) {
     ...
     */
    @Contract(pure = true)
    public ArgumentValidationFault(final boolean suppression, final boolean stackTrace) {
