 ...
 * @since 1.0.0-RC1
 */
public class ValueValidationFault extends ValidationFault {
     ...
     */
    @Contract(pure = true)
    public ValueValidationFault(final @Nullable String message) {
     ...
     */
    @Contract(pure = true)
    public ValueValidationFault(final @Nullable Throwable cause) {
     ...
     */
    @Contract(pure = true)
    public ValueValidationFault(final @Nullable String message, final @Nullable Throwable cause) {
     ...
     */
    @Contract(pure = true)
    public ValueValidationFault(final boolean suppression, final boolean stackTrace) {
