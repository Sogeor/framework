 ...
 * @since 1.0.0-RC1
 */
public class NullValueValidationFault extends ValueValidationFault {
     ...
     */
    @Contract(pure = true)
    public NullValueValidationFault() {
     ...
     */
    @Contract(pure = true)
    public NullValueValidationFault(final @Nullable String message) {
     ...
     */
    @Contract(pure = true)
    public NullValueValidationFault(final @Nullable Throwable cause) {
     ...
     */
    @Contract(pure = true)
    public NullValueValidationFault(final @Nullable String message, final @Nullable Throwable cause) {
     ...
     */
    @Contract(pure = true)
    public NullValueValidationFault(final boolean suppression, final boolean stackTrace) {
