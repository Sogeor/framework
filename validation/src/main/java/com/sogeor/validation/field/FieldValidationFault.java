...
/**
 * Представляет собой непроверяемую неисправность программы, возникающую из-за ошибки валидации поля.
 *
 * @since 1.0.0-RC1
 */
public class FieldValidationFault extends ValidationFault {
     ...
     * @since 1.0.0-RC1
     */
    public static final @NotNull String DEFAULT_MESSAGE = "Failed to validate the passed field";
     ...
     */
    @Contract(pure = true)
    public FieldValidationFault(final @Nullable String message) {
     ...
     */
    @Contract(pure = true)
    public FieldValidationFault(final @Nullable Throwable cause) {
     ...
     */
    @Contract(pure = true)
    public FieldValidationFault(final @Nullable String message, final @Nullable Throwable cause) {
     ...
     */
    @Contract(pure = true)
    public FieldValidationFault(final boolean suppression, final boolean stackTrace) {
