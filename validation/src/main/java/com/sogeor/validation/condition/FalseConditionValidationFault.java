...
/**
 * Представляет собой непроверяемую программную неисправность, возникающую при неудачной валидации условия, которое
 * должно быть истинным, но таковым не является.
 *
 * @since 1.0.0-RC1
 */
public class FalseConditionValidationFault extends ConditionValidationFault {
     ...
     * @since 1.0.0-RC1
     */
    public static final @NotNull String DEFAULT_MESSAGE = "The condition must be true";
     ...
     * @since 1.0.0-RC1
     */
    public static final @NotNull String TEMPLATE_MESSAGE = "%s must be true";
     ...
     */
    @Contract(pure = true)
    public FalseConditionValidationFault() {
     ...
     */
    @Contract(pure = true)
    public FalseConditionValidationFault(final @Nullable String message) {
     ...
     */
    @Contract(pure = true)
    public FalseConditionValidationFault(final @Nullable Throwable cause) {
     ...
     */
    @Contract(pure = true)
    public FalseConditionValidationFault(final @Nullable String message, final @Nullable Throwable cause) {
     ...
     */
    @Contract(pure = true)
    public FalseConditionValidationFault(final boolean suppression, final boolean stackTrace) {
