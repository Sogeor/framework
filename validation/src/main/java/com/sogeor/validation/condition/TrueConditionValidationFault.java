 ...
 * должно быть ложным, но таковым не является.
 *
 * @since 1.0.0-RC1
 */
public class TrueConditionValidationFault extends ConditionValidationFault {
     ...
     * @since 1.0.0-RC1
     */
    public static final @NotNull String DEFAULT_MESSAGE = "The condition must be false";
     ...
     * @since 1.0.0-RC1
     */
    public static final @NotNull String TEMPLATE_MESSAGE = "%s must be false";
     ...
     */
    @Contract(pure = true)
    public TrueConditionValidationFault() {
     ...
     */
    @Contract(pure = true)
    public TrueConditionValidationFault(final @Nullable String message) {
     ...
     */
    @Contract(pure = true)
    public TrueConditionValidationFault(final @Nullable Throwable cause) {
     ...
     */
    @Contract(pure = true)
    public TrueConditionValidationFault(final @Nullable String message, final @Nullable Throwable cause) {
     ...
     */
    @Contract(pure = true)
    public TrueConditionValidationFault(final boolean suppression, final boolean stackTrace) {
