...
/**
 * Представляет собой непроверяемую неисправность программы, возникающую при работе с функциями.
 *
 * @since 1.0.0-RC1
 */
public class FunctionFault extends UncheckedFault {
     ...
     */
    @Contract(pure = true)
    public FunctionFault(final @Nullable String message) {
     ...
     */
    @Contract(pure = true)
    public FunctionFault(final @Nullable Throwable cause) {
     ...
     */
    @Contract(pure = true)
    public FunctionFault(final @Nullable String message, final @Nullable Throwable cause) {
     ...
     */
    @Contract(pure = true)
    public FunctionFault(final boolean suppression, final boolean stackTrace) {
     ...
     */
    @Contract(pure = true)
    public FunctionFault(final @Nullable String message, final @Nullable Throwable cause, final boolean suppression,
